...
// This code is broken to all hell and I have no idea what happend, It never checked any of my if statements and just played them in order regardless of input and while I was working on it curly brackets got reassinged. 
// I have given up for now because I've done nothing wrong from what I can see and have no idea what has happend. 
int main() {
